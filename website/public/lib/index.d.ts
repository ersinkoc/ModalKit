 ...
 */
declare function createModal(userConfig?: ModalConfig): Modal;
 ...
 */
declare const modalStack: ModalStack & {
 ...
 */
declare const scrollLock: ScrollLock;
...
export { type AlertOptions, type AnimationState, type AnimationType, type CloseButtonProps, type ConfirmButton, type ConfirmOptions, type ConfirmOptionsAdvanced, type ContainerProps, type ContentProps, type DescriptionProps, type FocusTrap, type FocusTrapConfig, type Modal, type ModalConfig, type ModalStack, type ModalState, type OverlayProps, type PortalProps, type PromptOptions, type ScrollLock, type StackEvent, type TitleProps, type TriggerProps, alert, confirm, createFocusTrap, createModal, modalStack, prompt, scrollLock };
